...
public class Staff_Login_Form extends javax.swing.JFrame {
JDBC obj=new JDBC();
Staff_Login object=new Staff_Login();
    ...
    public Staff_Login_Form() {
        ...
        Connection con = objJDBC.establishConnection();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/project3.png"))); // NOI18N
...
new Staff_Login_Form().setVisible(false);
...
dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Staff_Login_Form().setVisible(true);
            }
        });
    }
